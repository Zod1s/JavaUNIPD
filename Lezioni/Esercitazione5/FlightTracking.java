...
public class FlightTracking
{
    public static void main(String[] args)
    {
        ...
        SimpleAircraft b737 = new SimpleAircraft(MODEL1, AIRPORT1, MAX_LENGTH1, MAX_HEIGHT1, MAX_MILEAGE1);
        System.out.println(b737);

        SimpleAircraft a340 = new SimpleAircraft(MODEL2, AIRPORT2, MAX_LENGTH2, MAX_HEIGHT2, MAX_MILEAGE2);
